    ...
    return (
        <div className="container-fluid">
            <div className="row flex-nowrap">
                        ...
                        <div className="pb-4 mx-auto">
                            <NavLink to="#!" className="d-flex align-items-center text-white text-decoration-none" id="dropdownUser1" aria-expanded="false">
                                <div className="profilePicName">
                                    <img src="/assets/passport.png" alt="hugenerd" className="rounded-circle profilePic img-fluid" width="100" height="100" />
                                    <h6 className="fs-5 mt-1 fw-bolder d-none d-md-block d-lg-block">Akerele B.</h6>
                                    <p className="opacity-75 d-none d-md-block d-lg-block">Grade 1</p>
                                </div>
                            </NavLink>
                        </div>
                ...
                <div className="col">
                    <Outlet />
                    <footer style={{ backgroundColor: '#1364DC' }}>
