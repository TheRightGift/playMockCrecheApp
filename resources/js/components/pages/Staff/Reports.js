    ...
    return (
        props.kids.map((data) =>
            <tr key={data.id} className="shadow bg-white fw-normal">
                ...
                <td className="bg-primary text-white"><span className={data.feeding ? 'btnTime text-system' : null}>{data.feeding}</span></td>
                <td className="bg-primary text-white"><span className={data.feeding ? 'btnTime text-system' : null}>{data.diaper}</span></td>
                <td className="bg-primary text-white"><span className={data.feeding ? 'btnTime text-system' : null}>{data.nap}</span>{data.nap ? ' to ' : null} <span className={data.feeding ? 'btnTime text-system' : null}> {data.nap_to}</span></td>
                <td className="bg-primary text-white"><span className={data.feeding ? 'btnTime text-system' : null}>{data.arrival}</span></td>
                <td className="bg-primary text-white"><span className={data.feeding ? 'btnTime text-system' : null}>{data.departure}</span></td>
...
export default function Report() {
    const [kids, setKids] = useState(reports);
